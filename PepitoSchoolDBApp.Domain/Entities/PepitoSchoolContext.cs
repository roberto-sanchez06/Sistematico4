...
namespace PepitoSchoolDBApp.Domain.Entities
{
...
//                optionsBuilder.UseSqlServer("Data Source=LAPTOP-P8O459K8;Initial Catalog=PepitoSchool;user=sa;password=$CentroDErD92$");
//            }
        }
